show_ssh_session() {
  local index=$1
  local icon="$(get_tmux_option "@catppuccin_ssh_session_icon" "")"
  local color="$(get_tmux_option "@catppuccin_ssh_session_color" "$thm_blue")"
  showSshSession="$(main)"
  local text="$(get_tmux_option "@catppuccin_ssh_session_text" "$showSshSession")"
